...
此模板提供了一个最小化的设置，让 React 在 Vite 中运行，支持热模块替换 (HMR) 并包含一些 ESLint 规则。
...
此模板未启用 React 编译器，因为它会影响开发和构建性能。如需添加，请参阅[此文档](https://react.dev/learn/react-compiler/installation)。
...
Made By Artificial_Intelligence
